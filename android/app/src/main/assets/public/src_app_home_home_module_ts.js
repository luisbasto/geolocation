(self["webpackChunkgeolocation"] = self["webpackChunkgeolocation"] || []).push([["src_app_home_home_module_ts"],{
...
let HomePage = class HomePage {
    ...
    track() {
        this.watchId = _capacitor_geolocation__WEBPACK_IMPORTED_MODULE_2__.Geolocation.watchPosition({}, (position, err) => {
            this.lat = position.coords.latitude;
            this.lng = position.coords.longitude;
        });
    }
    stopTracking() {
        _capacitor_geolocation__WEBPACK_IMPORTED_MODULE_2__.Geolocation.clearWatch({ id: this.watchId });
    }
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Geolocation\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n\n<ion-item>\n  <ion-label>Latitude:</ion-label>\n  <ion-label *ngIf=coords> {{coords.latitude}} </ion-label>\n</ion-item>\n<ion-item>\n  <ion-label>Longitude:</ion-label>\n  <ion-label *ngIf=coords> {{coords.longitude}} </ion-label>\n</ion-item>\n<ion-item>\n  <ion-label>Altitude:</ion-label>\n  <ion-label *ngIf=coords> {{coords.altitude}} </ion-label>\n</ion-item>\n<ion-item>\n  <ion-label>Accuracy:</ion-label>\n  <ion-label *ngIf=coords> {{coords.accuracy}} </ion-label>\n</ion-item>\n\n<ion-item>\n  <ion-label>Watch Position</ion-label>\n</ion-item>\n\n<ion-item>\n  <ion-label>Latitude:</ion-label>\n  <ion-label *ngIf=lat> {{lat}} </ion-label>\n</ion-item>\n<ion-item>\n  <ion-label>Longitude:</ion-label>\n  <ion-label *ngIf=lng> {{lng}} </ion-label>\n</ion-item>\n</ion-content>\n");
